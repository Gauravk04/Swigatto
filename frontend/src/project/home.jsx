      ...
      <>
           ...
           Signup
            ...
            <div className="title1">
              ...
              <div className="sub-title1">
                Order food from favourite resturants near you.
              </div>
            </div>
        ...
        <div className="features">
          <div className="feature">
            <div>
              <img className="feature-image" src={order} alt="" />
            </div>
          ...
          <div className="feature">
            <div>
              <img className="feature-image" src={ice_cream} alt="" />
            </div>
        ...
        <div className="footer1">
          <div className="credits1">
            Created/Developed By Aman || Copyright © 2024 Aman. All rights
            reserved.
          </div>
        </div>
      </>
